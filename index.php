...
/* starting session here, this is just a test for seession testing */
session_start();
/* up to here session here, this is just a test for seession testing */
...
if (isset($_POST['fromGame'])) {
	...
	/* assumption for the session name to be here */
//	$_SESSION["user"] = $_POST['userNameFromGame'];
	/*  */
} /*
...
<body>
		...
		<div class="container py-3">
			<div class="row">
				...
				<div class="col-md-4 d-flex justify-content-end align-items-start">
					...
					<span class="ml-4 mt-2"><a href="./" target="_SELF">Admin</a></span>
				</div>
			</div>
		</div>
	</nav>
			...
			<div class="row">
				...
				<div id="login-part">
					<div class="col-md-4 offset-md-2 ">
						<div id="login-page" style="display: block;">
							<div class="card">
								...
								<div class="card-body">
									...
									<form id="loginFromHead" method="POST">
										...
										<div class="input-group form-group">
											...
											<input type="password" id ="pswd" class="form-control" name="pass" placeholder="Password" value="">
										</div>
						...
						<div id="login-approval" style="display: none">
							<div class="card">
								<div class="card-header">
									<h3>Welcome back, <br><span id="showNameAfterLogin"></span></h3>
									<?php ?>
								</div>
								<div class="card-body">
	...
	<script src="js/loginSumit.js"></script>
